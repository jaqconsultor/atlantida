...
<form ngNativeValidate [formGroup]="formularioGrupo" (ngSubmit)="enviardatos()">
  <div class="card">
    <div class="card-header alert alert-primary">
      Datos General del Contratante ( <?php echo $_GET['id'] ?> )
    </div>
    <div class="card-body">
  ...
  <div class="card">
    <div class="card-footer text-muted">
      <div class="row">
        ...
        <div class="col-4">
          <a class="btn btn-info"  href="formularios/verificar.php?id=<?php echo $id ?>">Verificar</a>
        </div>
        <div class="col-4">
          <a class="btn btn-danger" routerLink="/listar" href="formularios/modificar.php">Cancelar</a>
        </div>
      </div>
    </div>
  </div>
