...
<?php
$sqlEmpleaados = mysqli_query($conexionBD,"SELECT * FROM contratos where Estado='H'");
if(mysqli_num_rows($sqlEmpleaados) > 0){
	...
	foreach($empleaados as $service){
        ...
        echo "<td>" . $service["Estado_Observacion"] . "</td>";
		$url = "<a href='https://atlantidascs.com/formularios/ver.php?id=" . $service["id"] . "' class='btn btn-info' >Ver</a>";
		echo "<td>" . $url . "</td>";
		echo "</tr>";
	}
}
